...
**Latest gates (all green):** `cargo test` 52/52 (+3 `#[ignore]`d on demand) + `clippy` 0 · `tsc` 0 · `vitest` 46/46 · `vite build` 0 · Playwright renders + live WebGL/terminal end-to-end (0 console errors). Proof shots in `docs/proof/`.
