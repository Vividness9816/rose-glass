...
- **Phase 7 — DONE** (embedded terminal). Next headlessly-verifiable legs: **Phase 9 — MuPDF/docx editors** (opens with a spike) · **Phase 10 — MCP sidecar** · **Phase 11 — embeddings/clusters** · **Phase 12 — v1.0 gate**.
